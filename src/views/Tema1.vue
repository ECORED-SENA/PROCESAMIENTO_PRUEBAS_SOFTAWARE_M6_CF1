...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-6
        p.mb-0 Las pruebas de software se definen como una actividad en la cual un sistema, o uno de sus componentes se ejecuta en circunstancias previamente especificadas, los resultados se observan, se registran y se realiza una evaluación de algún aspecto. Hacen parte de una fase primordial en el proceso de desarrollo de software; en muchos casos, se definen como el método y proceso para la verificación y validación de las funcionalidades del software. Estas pruebas son requeridas en el control de calidad y mantenimiento de software, para certificar la calidad y el aseguramiento; por lo general, se acompañan de otras técnicas, como supervisiones, comprobaciones de pares o procesos automatizados, revisión de documentación de las primeras fases o formatos que no son ejecutables.
      .col-lg-6
        figure
    ...
    .row.justify-content-center.mb-5
      .col-lg-10      
        .cajon.color-primario.p-5
          p.mb-4 Aplicar pruebas de software permitirá encontrar o identificar bugs, errores o incidencias, en etapas tempranas del ciclo de desarrollo, con el fin de tomar acción rápidamente, detectando niveles inadecuados de calidad o diferencias con lo establecido en su definición funcional, para así aplicar un proceso de mejora.
          p.mb-0 En el proceso de pruebas, se revisa e inspecciona el producto bajo condiciones definidas específicamente, y eventualmente se puede hacer uso de software especializado (CAST- Computer Aided Software Testing) como apoyo.
    
    p.mb-4 El proceso de pruebas de software se debe destacar por el orden y disciplina al momento de planear y ejecutar, con indicadores, métricas y objetivos establecidos de tal manera que permitan determinar una evaluación correcta del producto; el resultado de estas actividades son los reportes que documentan la interacción entre el producto y el usuario, y hace énfasis especial en las fallas encontradas. Este proceso puede verse como una secuencia de actividades, donde cada una de sus etapas permite generar productos, artefactos, insumos asociados, recursos, e involucra distintos actores y diferentes roles.
    ...
    .row.justify-content-center.mb-5
      .col-lg-8
        ImagenInfografica.color-secundario.mb-5
          ...
          .tarjeta.color-acento-contenido.p-3(x="15.5%" y="24%" numero="1")
            .h5.mb-2 Diseñar casos de prueba.
          .tarjeta.color-acento-contenido.p-3(x="40.5%" y="11.5%" numero="2")
            .h5.mb-2 Aplicar casos de prueba.
          .tarjeta.color-acento-contenido.p-3(x="47.5%" y="49%" numero="3")
            .h5.mb-2 Reportar métricas y dar seguimiento.
          .tarjeta.color-acento-contenido.p-3(x="63%" y="24%" numero="4")
            .h5.mb-2 Reportar análisis de resultados.
          .tarjeta.color-acento-contenido.p-3(x="78.5%" y="52%" numero="5")
            .h5.mb-2 Mientras no se cumplan los criterios de aceptación, continuar con la validación.
          .tarjeta.color-acento-contenido.p-3(x="94%" y="77%" numero="6")
    ...
    .row.justify-content-center.mb-5
      .col-lg-6
        p.mb-0 <b>En las pruebas de software es necesario contar con altos estándares de calidad, con el fin de cumplir a cabalidad las necesidades establecidas en los requisitos funcionales y los no funcionales dadas por el cliente, y poder entregar la documentación requerida.</b>
      .col-lg-6
        p.mb-0 Cualquier error en el software derivará en una falla que debe ser detectada a tiempo, por lo cual las pruebas deben certificar que se cuenta con el resultado esperado en la ejecución, o de lo contrario reportarlo para su corrección. Los principales objetivos que se buscan con la fase de prueba de software son:
    
    TabsA.color-acento-contenido
      .tarjeta--gris.p-4(titulo="Establecer nivel de calidad")
        h4 Establecer nivel de calidad
        p.mb-0 Establecer el nivel de calidad del producto software.
      ...
      .tarjeta--gris.p-4(titulo="Adquirir producto con estado de madurez")
        ...
        p.mb-0 No realizar la adquisición de un producto software hasta que tenga un estado de madurez y estabilidad alto, con la finalidad de minimizar riesgos. 
      ...
      .tarjeta--gris.p-4(titulo="Minimizar los costos")
        ...
        p.mb-0 Minimizar costos de mantenimiento. Las pruebas de software en fases tempranas permiten identificar oportunamente fallos, por lo cual se podrá determinar un plan de correctivos de forma rápida. 
      .tarjeta--gris.p-4(titulo="Reconocer lecciones aprendidas")
        h4 Reconocer lecciones aprendidas
        p.mb-0 Las pruebas de software generan una serie de lecciones aprendidas, las cuales permiten emplearse como apoyo para la mejora de procesos y desarrollo de los diferentes productos. 
    ...
    #t_1_3.titulo-segundo
      h2 1.3 Objetivos de las pruebas de software

    p.mb-5 La prueba de software es un recurso fundamental para la garantía del correcto funcionamiento del software, entre sus objetivos, se busca garantizar los siguientes aspectos:

    ol.lista-ol--cuadro.lista-ol--separador
      li 
        .t1.lista-ol--cuadro__vineta
          span 1
        | Detectar errores o defectos en el software.
      li 
        .t1.lista-ol--cuadro__vineta
          span 2
      ...
      li 
        .t1.lista-ol--cuadro__vineta
          span 4
        | Generar un seguimiento y asegurar que los defectos encontrados se han corregido antes de liberar el software al cliente.
      li 
        .t1.lista-ol--cuadro__vineta
          span 5
    ...
    #t_1_4.titulo-segundo
      h2 1.4 Ciclo de ejecución de las pruebas de software
    ...
    AcordionA(tipo="b" clase-tarjeta="tarjeta")
      .row(titulo="Escenarios")
        .col-lg-12
          p.mb-4 Los escenarios son una instancia o una representación de un caso de uso, de tal manera que permiten ejecutar un flujo completo de eventos de la funcionalidad descrita. El flujo básico de un caso de uso se define como un escenario, y este por lo general representa un happy path, entre otros. Cada flujo alterno se define como un escenario alterno, que puede llegar a ser un happy path o un error path. Se puede llegar a la conclusión que un caso de uso describe diferentes escenarios de uso y estos pueden definirse de la siguiente manera:

          p.mb-0 <b>a.</b> Escenarios correspondientes al flujo básico del caso de uso o happy path. 
      ...
      .row(titulo="Generación de casos de prueba")
        .col-lg-12
          ...
          p.mb-4 Más adelante, en el 2001, Jim Heuman, trabajador de Rational SW Corporation, publica un artículo en el cual se describe y define el procedimiento con el cual generar casos de prueba a partir de casos de uso; dicho proceso basado en RUP, el cual consta de tres pasos:
    ...
    p.mb-4 Los criterios de aceptación definen los requisitos del cliente, indicando cómo debe comportarse el producto software para una determinada acción que se pueda llevar a cabo, generalmente por una acción desencadenada por un usuario de la aplicación, respondiendo si se ha construido correctamente el producto o si se ha construido el producto correcto. 
    p.mb-5 Deben describir un contexto, una acción o evento y una consecuencia o respuesta esperada del sistema. La forma más utilizada para describir los criterios de aceptación es la conocida como Given-When-Then. Aquí un ejemplo:
    ...
    p.mb-4 Aunque expresan el comportamiento del producto software, siempre es utilizado un lenguaje de negocio, no técnico. En el anterior ejemplo, se usó <b>“Cuando intenta ingresar a alguna funcionalidad reservada o privada”</b> y no <b>“Cuando hace clic en alguna de las opciones del menú que están restringidas por el inicio de sesión”</b>. La precisión en la definición de los criterios de aceptación depende de la madurez y experiencia del equipo de desarrollo. 
    p.mb-0 Recuerde: hacer uso de los criterios de aceptación en la definición de requisitos de software o historias de usuario, dependiendo de la metodología empleada, permitirá tener claro el alcance de la implementación y cuándo finaliza, la funcionalidad de lo construido es lo que el cliente requería y, además, lo que el usuario necesita.   
    Separador

    #t_1_7.titulo-segundo
      h2 1.7 Niveles de aplicació5n de las pruebas de software
    .row.justify-content-center.mb-5
      .col-lg-5
      ...
      .col-lg-7
        p.mb-4 Cada fase en el proceso de desarrollo de pruebas está asociada a una de las etapas de construcción de software. Aunque no es estricto que ambas fases trabajen en paralelo, sí deberán estar en constante comunicación y mutua colaboración. 
        p.mb-0 En la siguiente figura, se presenta el modelo V que se aplica al proceso de desarrollo de pruebas de software:
    ...
    p.mb-5 Las pruebas de software se pueden clasificar en dos tipos principalmente: 
    .row.justify-content-center.mb-5
      .col-lg-8
        figure
          img(src='@/assets/curso/tema1/img15.svg') 
    p.mb-5 Teniendo en cuenta los diferentes frentes y aspectos de un producto software, con lo cual se requerirán diferentes tipos de pruebas, tales como: pruebas unitarias, pruebas de integración, pruebas de estrés, pruebas de rendimiento, pruebas de escalabilidad, entre otras. Cada uno de estos tipos de pruebas de software determina la visibilidad de la aplicación, desde el código fuente hasta la interacción y experiencia con el usuario. Entrando en detalles, algunos de los tipos de pruebas más comunes son: 
      ...
      .py-3.py-md-4(titulo="Pruebas de rendimiento")
        .row.justify-content-center
          ...
          .col-lg-6
            ...
            p.mb-0 Son un tipo de pruebas no funcionales, las cuales se realizan con la finalidad de determinar la estabilidad, escalabilidad y velocidad de una funcionalidad en el producto software. El objetivo de este tipo de pruebas es verificar el comportamiento de la aplicación teniendo en cuenta diferentes puntos de referencia del sistema y de la red, tales como la CPU, la velocidad de renderizado o carga de la página, el control de tráfico, la concurrencia, el consumo de recursos de servidor, entre otros. En esta categoría podemos encontrar las pruebas de carga y de esfuerzo. 

    p.mb-0 En conclusión, es posible decir que las pruebas de rendimiento son útiles para verificar el rendimiento del producto software; las pruebas funcionales se aplican para verificar que las funcionalidades están de acuerdo con lo establecido en el documento de requisitos funcionales y hacen lo que en los casos de uso está especificado; las pruebas de integración sirven para verificar la sinergia e integración entre los diferentes componentes y módulos descritos en un producto software; y las pruebas unitarias se definen para comprobar si son correctos los elementos como las clases, funciones, módulos o componentes que son tratados como una unidad. 
    Separador

    #t_1_9.titulo-segundo
      h2 1.9 Herramientas y soportes de las pruebas de software
    
    .row.justify-content-center.mb-5
      .col-lg-6
        p.mb-0 Son llamados “testers” aquellas personas encargadas de poner a prueba la calidad y el correcto funcionamiento de un producto software; esto se ejecuta por medio de una planificación previa, con la finalidad de mantenerse dentro de los tiempos establecidos y el presupuesto disponible. 
      .col-lg-6
  ...
  data: () => ({
    datosSlyder: [
      ...
      },
      {
        ...
        texto:
          'Estas herramientas miden las pruebas no funcionales, con las cuales se puede determinar el comportamiento en tiempo real del producto software o de alguna funcionalidad en específico, recreando distintas situaciones; y se complementan con las herramientas que supervisan, analizan, verifican y documentan el uso de los recursos de sistema, como la CPU, la RAM y el almacenamiento. ',
